...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 font-sans relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-96 h-96 bg-primary/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <p className="text-muted-foreground mt-2">Sign in to manage your extraordinary experiences</p>
        </div>
        ...
        <Card className="glass-effect border-white/20 dark:border-white/10 shadow-2xl overflow-hidden rounded-[2rem]">
          ...
          <CardContent className="grid gap-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background/50 px-2 text-muted-foreground backdrop-blur-sm">Or continue with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleLogin} className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  required
                  className="h-12 rounded-xl border-white/20 bg-white/5 focus-visible:ring-primary/30"
                />
              </div>
              <div className="grid gap-2">
          ...
          <CardFooter className="flex flex-col gap-4 border-t border-border/30 pt-6 pb-8">
